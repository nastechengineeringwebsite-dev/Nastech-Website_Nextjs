...
const GratefulTokenProductCard = ({ product }) => {
  ...
  return (
    <Flex
      className={
        "lg:w-[350px] md:w-[220px] w-[160px] flex flex-col lg:rounded-3xl rounded-xl overflow-hidden shadow-2xl"
      }
    ...
    >
      ...
      <Flex className={"lg:w-[350px] lg:h-[350px] md:w-[220px] md:h-[220px] w-[160px] h-[160px] bg-slate-300"}>
        <Image
