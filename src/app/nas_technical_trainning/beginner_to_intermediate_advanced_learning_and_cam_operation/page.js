    ...
    <AnimatePage>
      <Container>
        ...
        <Title
          className={"mt-10"}
          title={
            "Beginner to Intermediate Advance Learning+ Beginner to Intermediate CAM"
          }
          primaryTitle={true}
        ></Title>
        <Flex
        ...
        >
          <p>
            Start your fabrication journey with our comprehensive Beginner to
            Intermediate CAM course. Learn the essential skills to take your
            digital designs to physical reality. Through hands-on, project-based
            learning, you will gain a strong foundation in Computer-Aided
            Manufacturing, building the confidence to operate machinery and
